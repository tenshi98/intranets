...
$location = $original;
$new_location = "principal_eventos_archivos.php";
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'A1XRXS_sys/xrxs_form/seg_vecinal_eventos_listado_archivos.php';
}
//se borra un dato
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" enctype="multipart/form-data" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_multiple_upload('Seleccionar archivo','File_Upload', 25, '"jpg", "png", "gif", "jpeg", "bmp", "mp2", "mpeg", "mpg", "mov", "avi", "gz", "gzip", "7Z", "zip", "rar"');
...
WHERE idEvento = ".simpleDecode($_GET['id'], fecha_actual())."
ORDER BY Nombre ASC";
//Consulta
$resultado = mysqli_query ($dbConn, $query);
//Si ejecuto correctamente la consulta
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Evento', $rowdata['Tipo'], 'Adjuntar Archivos al Evento');?>
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="<?php echo 'principal_eventos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" ><i class="fa fa-flag" aria-hidden="true"></i> Resumen</a></li>
				...
				<li class="active"><a href="<?php echo 'principal_eventos_archivos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" ><i class="fa fa-file-archive-o" aria-hidden="true"></i> Archivos Adjuntos <span class="label label-danger"><?php echo $N_Archivos; ?></span></a></li>          
			</ul>	
		</header>
			...
			<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
				...
				<tbody role="alert" aria-live="polite" aria-relevant="all">
					<?php foreach ($arrArchivos as $zona) { ?>
						<tr class="odd">		
							<td><?php echo $zona['Nombre']; echo DB_SITE_REPO.DB_SITE_ALT_1_PATH.'/upload/'.$zona['Nombre']; ?></td>	
							<td>
