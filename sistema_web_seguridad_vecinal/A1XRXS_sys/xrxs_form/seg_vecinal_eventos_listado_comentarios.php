...
/*******************************************************************************************************************/		
		case 'new_comment':
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `seg_vecinal_eventos_listado_comentarios` (idEvento, idCliente,
...
/*******************************************************************************************************************/		
		case 'comment_likes':
			...
			if(isset($idCliente)&&isset($idComentario)){
				$ndata_1 = db_select_nrows (false, 'idLikes', 'seg_vecinal_eventos_listado_comentarios_likes', '', "idCliente='".$idCliente."' AND idComentario='".$idComentario."'", $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
			}
			...
			if ( empty($error) ) {
				...
				$rowdata = db_select_data (false, 'nLikes, nDislikes', 'seg_vecinal_eventos_listado_comentarios', '', 'idComentario = "'.$idComentario.'"', $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, $form_trabajo);
				...
				// inserto los datos de registro en la db
				$query  = "INSERT INTO `seg_vecinal_eventos_listado_comentarios_likes` (idComentario, idCliente,
