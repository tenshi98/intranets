...
/*******************************************************************************************************************/		
		case 'post_report':
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `seg_vecinal_reportes_post_listado` (idSistema, idEventoPeligro,
				idTipo, idCliente, Fecha, Hora, Comentario, idRevisado) 
				VALUES (".$a.")";
				//Consulta
				...
				if($resultado){
					...
					//se redirige
					header( 'Location: '.$location.'&report=true' );
					die;
