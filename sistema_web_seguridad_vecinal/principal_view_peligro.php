...
$original = "principal_view_peligro.php";
$location = $original;
//Se agregan ubicaciones
$location .='?view='.$_GET['view'];
//Titulo ventana
$t_dashboard = '<i class="fa fa-ban" aria-hidden="true"></i> Ver Zona Peligrosa';
/**********************************************************************************************************************************/
...
if ( !empty($_POST['submit_comment']) )  { 
	...
	require_once 'A1XRXS_sys/xrxs_form/seg_vecinal_peligros_listado_comentarios.php';
}
...
if (isset($_GET['report'])) {          $error['usuario'] = 'sucess/Zona de Peligro reportada correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
				...
				$Form_Inputs->form_input_hidden('idPeligro', $_GET['post_report'], 2);
				$Form_Inputs->form_input_hidden('idComentario', $_GET['comment_report'], 2);
				$Form_Inputs->form_input_hidden('idTipo', simpleEncode(1, fecha_actual()), 2);
...
seg_vecinal_peligros_listado_comentarios.idValidado,
seg_vecinal_peligros_listado_comentarios.nLikes,
seg_vecinal_peligros_listado_comentarios.nDislikes,
...
WHERE seg_vecinal_peligros_listado_comentarios.idPeligro=".$Identif;
//Consulta
...
/*******************************************************************************/
//cuento los peligros
$n_Peligro     = db_select_nrows (false, 'idPeligro', 'seg_vecinal_peligros_listado', '', "idCliente='".$_SESSION['usuario']['basic_data']['idCliente']."' AND FechaCreacion='".fecha_actual()."'", $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'N_Peligro');
$n_max_peligro = 3;		 
?>

<div class="col-sm-12 breadcrumb-bar">

	<?php if($n_Peligro<=$n_max_peligro){ ?>
		<a href="principal_peligros.php?pagina=1&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Zona Peligrosa</a>
	<?php } ?>
			...
			<div class="col-sm-8">
				<div class="row" style="border-right: 1px solid #333;">
					<div class="col-sm-12">
						...
						<?php if($_SESSION['vecinos_peligros'][$Identif]['idValidado']==1){ ?>
						...
						<p class="text-muted word_break">
							<strong>Tipo de Peligro : </strong><?php echo $_SESSION['vecinos_peligros'][$Identif]['Tipo']; ?><br/>
							<strong>Ciudad : </strong><?php echo $_SESSION['vecinos_peligros'][$Identif]['Ciudad']; ?><br/>
							<strong>Comuna : </strong><?php echo $_SESSION['vecinos_peligros'][$Identif]['Comuna']; ?><br/>
							<strong>Direccion : </strong><?php echo $_SESSION['vecinos_peligros'][$Identif]['Direccion']; ?><br/>
							<strong>Descripcion : </strong><?php echo $_SESSION['vecinos_peligros'][$Identif]['Descripcion']; ?><br/>
										
						</p>
						
						<?php if(isset($_SESSION['vecinos_peligros_archivos'][$Identif])) { ?>
					...
					$direccion = "";
					if(isset($_SESSION['vecinos_peligros'][$Identif]["Direccion"])&&$_SESSION['vecinos_peligros'][$Identif]["Direccion"]!=''){   $direccion .= $_SESSION['vecinos_peligros'][$Identif]["Direccion"];}
					if(isset($_SESSION['vecinos_peligros'][$Identif]["Comuna"])&&$_SESSION['vecinos_peligros'][$Identif]["Comuna"]!=''){         $direccion .= ', '.$_SESSION['vecinos_peligros'][$Identif]["Comuna"];}
					if(isset($_SESSION['vecinos_peligros'][$Identif]["Ciudad"])&&$_SESSION['vecinos_peligros'][$Identif]["Ciudad"]!=''){         $direccion .= ', '.$_SESSION['vecinos_peligros'][$Identif]["Ciudad"];}
					//se despliega mensaje en caso de no existir direccion
					if($direccion!=''){
						echo mapa_from_gps($_SESSION['vecinos_peligros'][$Identif]['GeoLatitud'], $_SESSION['vecinos_peligros'][$Identif]['GeoLongitud'], 'Zona de Peligro', 'Calle', $direccion, $_SESSION['usuario']['basic_data']['Config_IDGoogle'], 19, 2);
					}else{
							...
							<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
								<div class="field">
									<div class="input-group">
										...
										<input type="hidden" name="idPeligro"  id="idPeligro"  value="<?php echo $_GET['view']; ?>" required="">
