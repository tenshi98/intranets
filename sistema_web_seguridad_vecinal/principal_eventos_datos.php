...
seg_vecinal_eventos_listado.idCiudad,
seg_vecinal_eventos_listado.idComuna,
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Evento', $rowdata['Tipo'], 'Editar Datos del Evento');?>
</div>
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="<?php echo 'principal_eventos_datos.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar Datos</a></li>
			...
			<div class="col-sm-6">
				<div style="margin-top:20px;">
					<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
						...
						if(isset($DescripcionTipo)) {      $x2 = $DescripcionTipo;       }else{$x2  = $rowdata['DescripcionTipo'];}
						...
						if(isset($DescripcionSituacion)) { $x8 = $DescripcionSituacion;  }else{$x8  = $rowdata['DescripcionSituacion'];}
						...
						$Form_Inputs->form_input_disabled('Direccion Encontrada', 'Direccion_fake', $x5, 1);
