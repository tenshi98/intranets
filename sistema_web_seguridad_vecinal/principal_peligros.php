...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Zona Peligrosa Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Zona Peligrosa Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Zona Peligrosa borrada correctamente';}
...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Zona de Peligro', $rowdata['Tipo'], 'Resumen');?>
</div>
	...
	<div class="box">
		<header>
			<ul class="nav nav-tabs pull-right">
				<li class="active"><a href="<?php echo 'principal_peligros.php?pagina='.$_GET['pagina'].'&id='.$_GET['id'];?>" ><i class="fa fa-flag" aria-hidden="true"></i> Resumen</a></li>
...
<div class="col-sm-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table" aria-hidden="true"></i></div><h5>Crear Nuevo Peligro</h5>	
		</header>
			...
			<div class="col-sm-6">
				<div style="margin-top:20px;">
					<form class="form-horizontal" method="post" id="form1" name="form1" novalidate>
						...
						$Form_Inputs->form_select('Tipo de Peligro','idTipo', $x1, 2, 'idTipo', 'Nombre', 'seg_vecinal_peligros_tipos', 0, '',$dbConn);
						...
						$Form_Inputs->form_input_hidden('Hora', hora_actual(), 2);
...
$z = "WHERE seg_vecinal_peligros_listado.idCliente=".$_SESSION['usuario']['basic_data']['idCliente'];
/**********************************************************/
...
if(isset($_GET['Descripcion']) && $_GET['Descripcion'] != ''){  $z .= " AND seg_vecinal_peligros_listado.Descripcion LIKE '%".$_GET['Descripcion']."%'";}
...
/*******************************************************************************/
//cuento los peligros
$n_Peligro     = db_select_nrows (false, 'idPeligro', 'seg_vecinal_peligros_listado', '', "idCliente='".$_SESSION['usuario']['basic_data']['idCliente']."' AND FechaCreacion='".fecha_actual()."'", $dbConn, $_SESSION['usuario']['basic_data']['Nombre'], $original, 'N_Peligros');
$n_max_peligro = 3;
?>
...
<div class="col-sm-12 breadcrumb-bar">
	...
	<ul class="btn-group btn-breadcrumb pull-left">
		...
		<li class="btn btn-default"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i> Estado Ascendente</li>
	...
	<?php if($n_Peligro<=$n_max_peligro){ ?>
		<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width fmrbtn" ><i class="fa fa-file-o" aria-hidden="true"></i> Crear Zona Peligrosa</a>
	<?php } ?>
	...
	<div class="well">
		<div class="col-sm-8 fcenter" style="min-height:500px;">
			<form class="form-horizontal" id="form1" name="form1" action="<?php echo $location; ?>" novalidate>
				...
				$Form_Inputs->form_select('Estado','idEstado', $x7, 1, 'idEstado', 'Nombre', 'core_estados', 0, '',$dbConn);
						...
						<tr class="odd">
							...
							<td>
								<div class="btn-group" style="width: 70px;" >
									...
									<a href="<?php echo $location.'&id='.simpleEncode($eve['idPeligro'], fecha_actual()); ?>" title="Editar Informacion" class="btn btn-success btn-sm tooltip"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
								</div>
							</td>
						</tr>
					<?php } ?>                    
