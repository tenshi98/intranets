...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Chofer', $rowdata['Nombre'].' '.$rowdata['ApellidoPat'].' '.$rowdata['ApellidoMat'], 'Editar Foto');?>
</div>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['Direccion_img'])&&$rowdata['Direccion_img']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						<img src="<?php echo DB_SITE_ALT_1; ?>/upload/<?php echo $rowdata['Direccion_img'] ?>" width="100%" class="img-thumbnail" > 
						<br/>
