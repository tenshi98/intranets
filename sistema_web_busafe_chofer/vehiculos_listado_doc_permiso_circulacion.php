...
$query = "SELECT Nombre,Patente,doc_permiso_circulacion, doc_fecha_permiso_circulacion
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['doc_permiso_circulacion'])&&$rowdata['doc_permiso_circulacion']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_permiso_circulacion'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); ?>
						<br/>
