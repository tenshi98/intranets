...
$location = $original;
//Titulo ventana
$t_dashboard = '<i class="fa fa-address-card-o" aria-hidden="true"></i> Registros Velocidades';
/**********************************************************************************************************************************/
					...
					<tr class="odd">
						...
						<td>
							<div class="btn-group" style="width: 35px;" >
								<a href="<?php echo 'informe_vehiculos_registro_velocidad_view.php?idVehiculo='.$_GET['idVehiculo'].'&view='.$rutas['idTabla']; ?>" title="Ver Informacion" class="iframe btn btn-primary btn-sm tooltip"><i class="fa fa-list" aria-hidden="true"></i></a>
							</div>
						</td>
					</tr>
				<?php } ?>                     
