...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Chofer', $rowdata['Nombre'].' '.$rowdata['ApellidoPat'].' '.$rowdata['ApellidoMat'], 'Editar Curriculum');?>
</div>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['File_Curriculum'])&&$rowdata['File_Curriculum']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						<h3>Archivo</h3>
						<?php echo preview_docs('upload', $rowdata['File_Curriculum'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); ?>
						<br/>
