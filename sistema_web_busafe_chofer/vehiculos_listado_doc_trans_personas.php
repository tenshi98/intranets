...
$query = "SELECT Nombre,Patente, doc_cert_trans_personas, doc_fecha_cert_trans_personas
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['doc_cert_trans_personas'])&&$rowdata['doc_cert_trans_personas']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_cert_trans_personas'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); ?>
						<br/>
