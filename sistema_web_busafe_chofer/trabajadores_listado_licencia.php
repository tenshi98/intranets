...
<div class="col-sm-12">
	<?php echo widget_title('bg-aqua', 'fa-cog', 100, 'Chofer', $rowdata['Nombre'].' '.$rowdata['ApellidoPat'].' '.$rowdata['ApellidoMat'], 'Editar Licencia Laboral');?>
</div>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;">
				<form class="form-horizontal" method="post" id="form1" name="form1" novalidate enctype="multipart/form-data">		
					...
					if(isset($rowdata['File_Licencia'])&&$rowdata['File_Licencia']!=''){
						...
						echo preview_docs('upload', $rowdata['File_Licencia'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); 
						echo '</div>
