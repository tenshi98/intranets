			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li class="active"><a href="<?php echo 'trabajadores_listado_rhtm.php?pagina='.$_GET['pagina'].'&id='.$_GET['id']?>" ><i class="fa fa-files-o" aria-hidden="true"></i> Archivo - RHTM</a></li>
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['File_RHTM'])&&$rowdata['File_RHTM']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['File_RHTM'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); ?>
						<br/>
