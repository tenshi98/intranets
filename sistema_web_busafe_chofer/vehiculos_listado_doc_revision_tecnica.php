...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
// consulto los datos
$query = "SELECT Nombre,Patente, doc_revision_tecnica, doc_fecha_revision_tecnica
			...
			<div class="col-sm-8 fcenter" style="padding-top:40px;padding-bottom:40px;">
				...
				<?php if(isset($rowdata['doc_revision_tecnica'])&&$rowdata['doc_revision_tecnica']!=''){?>
					...
					<div class="col-sm-10 fcenter">
						...
						<?php echo preview_docs('upload', $rowdata['doc_revision_tecnica'], '', DB_SITE_REPO, DB_SITE_ALT_1_PATH); ?>
						<br/>
